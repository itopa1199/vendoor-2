      ...
      <div className="py-2">
        <div className="max-w-[1280px] mx-auto px-[14px] flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            {[
              { icon: User, label: 'Account', action: openSignIn },
              { icon: ShoppingCart, label: 'Cart', action: openCart, badge: count },
              { icon: Store, label: 'Sell', action: () => router.push('/vendor/dashboard') },
